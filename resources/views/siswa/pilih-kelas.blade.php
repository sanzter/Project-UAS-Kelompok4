    ...
    <div class="max-w-2xl mx-auto px-6 py-12">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden p-8">
            <form action="{{ route('siswa.simpan-kelas') }}" method="POST">
                ...
                <div class="mb-6">
                    <label for="kelas_id" class="block text-sm font-semibold text-gray-700 mb-2">Daftar Kelas
                        Tersedia</label>
                    <div class="relative">
                        <select name="nama_kelas" required class="w-full p-3 border ...">
                ...
                <div class="mt-8">
                    <button type="submit"
                        class="w-full flex justify-center py-3.5 px-4 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all">
                        Gabung ke Kelas
                    </button>
                    <p class="mt-3 text-xs text-center text-gray-500">Pilihan kelas bersifat permanen. Pastikan Anda memilih
                        kelas yang benar.</p>
                </div>
            </form>
        </div>
