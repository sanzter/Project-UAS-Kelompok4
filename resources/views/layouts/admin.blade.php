...
<head>
    ...
    <title>Simpsonv Admin — @yield('page-title', 'Dashboard')</title>
    ...
    <style>
        ...
        .card-admin {
            ...
            box-shadow: 0 1px 4px 0 rgba(109, 40, 217, 0.06);
        }
    </style>
</head>
        ...
        <div class="w-72 admin-sidebar shadow-2xl flex flex-col z-20 flex-shrink-0">
            <div class="px-8 pt-8 pb-6">
                <div class="flex items-center space-x-3 mb-2">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-white tracking-tight">Simpsonv</h2>
            ...
            <div class="p-5">
                ...
                <div class="flex items-center space-x-3 mb-4 px-2">
                    <div
                        class="w-9 h-9 bg-gradient-to-br from-violet-400 to-purple-600 rounded-xl flex items-center justify-center font-bold text-white text-sm">
