...
<head>
    ...
    <style>
        .guru-sidebar { background: #fff; border-right: 1px solid #d1fae5; }
        .guru-sidebar-item { color: #374151; border-radius: 0.75rem; padding: 0.85rem 1rem; display: flex; align-items: center; transition: all .2s; font-weight: 500; }
        .guru-sidebar-item:hover { background: #ecfdf5; color: #059669; }
        .guru-sidebar-item.active { background: #d1fae5; color: #065f46; font-weight: 700; }
        .guru-sidebar-item.active i { color: #059669; }
        .guru-badge { background: #059669; color: #fff; font-size: 0.65rem; font-weight: 800; padding: 2px 8px; border-radius: 99px; }
        .card-guru { background: #fff; border-radius: 1.25rem; border: 1px solid #d1fae5; box-shadow: 0 1px 4px 0 rgba(5,150,105,0.06); }
    </style>
</head>
    ...
    <div class="w-72 guru-sidebar shadow-sm flex flex-col z-20 flex-shrink-0">
        ...
        <div class="p-5">
            ...
            <div class="flex items-center space-x-3 mb-4 px-2">
                <div class="w-9 h-9 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-xl flex items-center justify-center font-bold text-white text-sm">
